...
The numbered repair total includes only the two source audits. The later change from a “first 100 customers” sale to a beta-through-0.9.x price rule is documented separately and is not counted among the 79 audit findings.
