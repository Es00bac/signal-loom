...
const MODEL_DEFINITIONS: ImageModelDefinition[] = [
  ...
  {
    providerId: 'atlas',
    modelId: 'atlascloud/qwen-image/edit-2511',
    label: 'Atlas Qwen Image Edit 2511',
    recommendedUse: 'Atlas Qwen 2511 editing variant for complex re-posing, text rendering, and mask-guided edits.',
    capabilities: caps({
      imageToImage: true,
      promptEdit: true,
      maskInpaint: true,
    ...
    visibleControls: ATLAS_QWEN_EDIT_CONTROLS,
    cost: { imageEditUsd: 0.025, fixedByOperationUsd: { 'mask-inpaint': 0.025 }, unitLabel: '$0.025/edit', confidence: 'published-fixed' },
    docsUrl: 'https://www.atlascloud.ai/models/atlascloud/qwen-image/edit-2511',
  },
  {
    providerId: 'atlas',
    modelId: 'fireredteam/firered-image-edit-1.0',
    label: 'Atlas FireRed Image Edit 1.0',
    recommendedUse: 'Atlas direct-to-latent photorealistic image manipulation for fast prompt edits.',
    capabilities: caps({
      imageToImage: true,
      promptEdit: true,
      referenceImages: true,
    ...
    visibleControls: ATLAS_IMAGE_EDIT_CONTROLS,
    cost: { unitLabel: 'Atlas account billed', confidence: 'provider-defined' },
    docsUrl: 'https://www.atlascloud.ai/models/fireredteam/firered-image-edit-1.0',
  },
  {
